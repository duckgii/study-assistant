...
const dictionary = {
  en: {
    ...
    "directory.emptyFolder": "This folder is empty. Upload a PDF or PPT file, or create a subfolder to get started.",
    ...
    "directory.renameDocumentAriaLabel": "Rename {{name}}",
    ...
    "directory.failedRenameDocument": "Failed to rename document.",
    "directory.uploadFailed": "Upload failed.",
    "directory.fileTooLarge": "File is too large. Maximum size is {{size}}MB.",
    ...
    "feedback.button": "Page feedback",
    "feedback.title": "Send feedback on this page",
    "feedback.pageContext": "Page {{page}} · {{section}}",
    "feedback.messagePlaceholder": "What's off, confusing, or could be better on this page?",
    "feedback.cancel": "Cancel",
    "feedback.send": "Send feedback",
    "feedback.sending": "Sending...",
    "feedback.sent": "Thanks — your feedback was sent.",
    "feedback.close": "Close",
    "feedback.sendFailed": "Couldn’t send your feedback. Please try again.",

    "feedbackAdmin.title": "Feedback",
    "feedbackAdmin.subtitle": "Submitted by students",
    "feedbackAdmin.loading": "Loading feedback...",
    "feedbackAdmin.loadFailed": "Failed to load feedback.",
    "feedbackAdmin.empty": "No feedback yet.",
    "feedbackAdmin.page": "p.{page}",
    "feedbackAdmin.unknownUser": "Unknown user",

    "adminDashboard.title": "Admin",
    "adminDashboard.subtitle": "Usage overview",
    "adminDashboard.loading": "Loading dashboard...",
    "adminDashboard.loadFailed": "Failed to load dashboard.",
    "adminDashboard.totalUsers": "Total users",
    "adminDashboard.uploaders": "Uploaded material",
    "adminDashboard.uploadersValue": "{{count}} ({{percentage}}%)",
    "adminDashboard.totalDocuments": "Documents uploaded",
    "adminDashboard.totalFeedback": "Feedback received",
    "adminDashboard.usersTitle": "Users",
    "adminDashboard.usersEmpty": "No users yet.",
    "adminDashboard.columnUser": "User",
    "adminDashboard.columnDocuments": "Documents",
    "adminDashboard.columnLastActive": "Last active",
    "adminDashboard.neverActive": "No activity yet",
    "adminDashboard.recentFeedbackTitle": "Recent feedback",
    "adminDashboard.recentFeedbackEmpty": "No feedback yet.",
    "adminDashboard.viewAllFeedback": "View all feedback →",
  },
  ko: {
    "header.home": "홈",
    "header.signOut": "로그아웃",
    ...
    "directory.emptyFolder": "이 폴더는 비어 있습니다. PDF 또는 PPT 파일을 업로드하거나 하위 폴더를 만들어 시작하세요.",
    ...
    "directory.renameDocumentAriaLabel": "{{name}} 이름 바꾸기",
    ...
    "directory.failedRenameDocument": "이름을 변경하지 못했습니다.",
    "directory.uploadFailed": "업로드에 실패했습니다.",
    "directory.fileTooLarge": "파일이 너무 큽니다. 최대 {{size}}MB까지 업로드할 수 있습니다.",
    ...
    "feedback.button": "페이지 피드백",
    "feedback.title": "이 페이지에 대한 피드백 보내기",
    "feedback.pageContext": "{{page}}페이지 · {{section}}",
    "feedback.messagePlaceholder": "이 페이지에서 어색하거나, 헷갈리거나, 개선하면 좋을 부분이 있나요?",
    "feedback.cancel": "취소",
    "feedback.send": "피드백 보내기",
    "feedback.sending": "보내는 중...",
    "feedback.sent": "피드백이 전송되었습니다. 감사합니다.",
    "feedback.close": "닫기",
    "feedback.sendFailed": "피드백 전송에 실패했습니다. 다시 시도해 주세요.",

    "feedbackAdmin.title": "피드백",
    "feedbackAdmin.subtitle": "학생들이 보낸 피드백",
    "feedbackAdmin.loading": "피드백을 불러오는 중...",
    "feedbackAdmin.loadFailed": "피드백을 불러오지 못했습니다.",
    "feedbackAdmin.empty": "아직 피드백이 없습니다.",
    "feedbackAdmin.page": "{{page}}쪽",
    "feedbackAdmin.unknownUser": "알 수 없는 사용자",

    "adminDashboard.title": "관리자",
    "adminDashboard.subtitle": "이용 현황",
    "adminDashboard.loading": "대시보드를 불러오는 중...",
    "adminDashboard.loadFailed": "대시보드를 불러오지 못했습니다.",
    "adminDashboard.totalUsers": "전체 유저",
    "adminDashboard.uploaders": "자료 업로드한 유저",
    "adminDashboard.uploadersValue": "{{count}}명 ({{percentage}}%)",
    "adminDashboard.totalDocuments": "업로드된 문서",
    "adminDashboard.totalFeedback": "받은 피드백",
    "adminDashboard.usersTitle": "유저 목록",
    "adminDashboard.usersEmpty": "아직 유저가 없습니다.",
    "adminDashboard.columnUser": "유저",
    "adminDashboard.columnDocuments": "업로드 문서",
    "adminDashboard.columnLastActive": "최근 활동",
    "adminDashboard.neverActive": "활동 기록 없음",
    "adminDashboard.recentFeedbackTitle": "최근 피드백",
    "adminDashboard.recentFeedbackEmpty": "아직 피드백이 없습니다.",
    "adminDashboard.viewAllFeedback": "전체 피드백 보기 →",
  },
} as const;
